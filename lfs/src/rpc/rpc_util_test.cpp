...
#include "rpc_util_test.hpp"
#include "rpcs_test.hpp"

using namespace std;

//  I need 1 argobots instance (i.e. ABT_pool to create threads) DONE
//  I need 1 hg_class and 1 hg_context instances for the SERVER DONE
//  I need 1 hg_class and 1 hg_context instances for the CLIENT DONE
...
bool destroy_margo_server_test(hg_class_t* hg_class, hg_context_t* hg_context) {
